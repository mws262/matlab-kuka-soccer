...
[tspan, posspan, velspan, accelspan, omegaspan, quatspan, ...
    world_contact_loc_desired_fcn, contact_loc_desired_rel_com_fcn] = evaluate_spline(nlp_sol, ball_radius, num_pts);
...
if write_to_vid
    framerate = 60;
    vid_writer = VideoWriter([vid_dir, 'magic_force_intermittent_contact_start_stop.avi']); % Convert for Slack with 'ffmpeg -i infile.avi youroutput.mp4'
