...
%% Options structure.
default_options.departure.velocity_normal = 0.2; % Normal component of velocity during the approach/departure segments. Tangent velocity is fully-determined.
...
default_options.approach.velocity_normal = 0.2;
